...
elf2hex_extra_args = $(mem_no_zero_fill_flag) $(if $(filter NIOS_onchip_memory2,$(target_stem)),--record=4)
...
$(MEM_0)_END := 0x00223fff
$(MEM_0)_HIERARCHICAL_PATH := BGM
$(MEM_0)_WIDTH := 64
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: BGM
BGM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: BLOCK_INFO
MEM_1 := BLOCK_INFO
$(MEM_1)_NAME := BLOCK_INFO
...
$(MEM_1)_START := 0x00229880
$(MEM_1)_END := 0x002298ff
$(MEM_1)_HIERARCHICAL_PATH := BLOCK_INFO
$(MEM_1)_WIDTH := 8
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: BLOCK_INFO
BLOCK_INFO: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: COS_TABLE
MEM_2 := COS_TABLE
$(MEM_2)_NAME := COS_TABLE
...
$(MEM_2)_START := 0x00229000
$(MEM_2)_END := 0x002293ff
$(MEM_2)_HIERARCHICAL_PATH := COS_TABLE
$(MEM_2)_WIDTH := 16
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: COS_TABLE
COS_TABLE: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym

# Memory: INV_DELTA
MEM_3 := INV_DELTA
$(MEM_3)_NAME := INV_DELTA
...
$(MEM_3)_START := 0x00224000
$(MEM_3)_END := 0x00227fff
$(MEM_3)_HIERARCHICAL_PATH := INV_DELTA
$(MEM_3)_WIDTH := 32
$(MEM_3)_ENDIANNESS := --little-endian-mem
$(MEM_3)_CREATE_LANES := 0

.PHONY: INV_DELTA
INV_DELTA: check_elf_exists $(MEM_INIT_DIR)/$(MEM_3).hex $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym

# Memory: VGA_TEXT
MEM_4 := NIOS_VGA_TEXT
$(MEM_4)_NAME := VGA_TEXT
...
$(MEM_4)_START := 0x00229800
$(MEM_4)_END := 0x0022987f
$(MEM_4)_HIERARCHICAL_PATH := VGA_TEXT
$(MEM_4)_WIDTH := 8
$(MEM_4)_ENDIANNESS := --little-endian-mem
$(MEM_4)_CREATE_LANES := 0

.PHONY: VGA_TEXT
VGA_TEXT: check_elf_exists $(MEM_INIT_DIR)/$(MEM_4).hex $(HDL_SIM_DIR)/$(MEM_4).dat $(HDL_SIM_DIR)/$(MEM_4).sym

# Memory: onchip_memory2
MEM_5 := NIOS_onchip_memory2
$(MEM_5)_NAME := onchip_memory2
...
$(MEM_5)_START := 0x00210000
$(MEM_5)_END := 0x0021ffff
$(MEM_5)_HIERARCHICAL_PATH := onchip_memory2
$(MEM_5)_WIDTH := 32
$(MEM_5)_ENDIANNESS := --little-endian-mem
$(MEM_5)_CREATE_LANES := 0

.PHONY: onchip_memory2
onchip_memory2: check_elf_exists $(MEM_INIT_DIR)/$(MEM_5).hex $(HDL_SIM_DIR)/$(MEM_5).dat $(HDL_SIM_DIR)/$(MEM_5).sym
